...
<body>
  ...
  <div class="destination-cards v-p-s-s" id="card-slider">
    ...
    // Function to handle the slider scroll with buttons
    const scrollSlider = (direction) => {
        const scrollAmount = 300; // Adjust scroll amount as needed
        cardSlider.scrollBy({ left: direction * scrollAmount, behavior: 'smooth' });
    };

    // Event listeners for buttons
    leftButton.addEventListener("click", () => scrollSlider(-1)); // Scroll left
    rightButton.addEventListener("click", () => scrollSlider(1));  // Scroll right
